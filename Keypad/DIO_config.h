...
#define DIO_u8_PC0_INITIAL_VALUE                DIO_u8_INITIAL_OUTPUT_HIGH
#define DIO_u8_PC1_INITIAL_VALUE                DIO_u8_INITIAL_OUTPUT_HIGH
#define DIO_u8_PC2_INITIAL_VALUE                DIO_u8_INITIAL_OUTPUT_HIGH
#define DIO_u8_PC3_INITIAL_VALUE                DIO_u8_INITIAL_OUTPUT_HIGH
#define DIO_u8_PC4_INITIAL_VALUE                DIO_u8_INITIAL_INPUT_PULLUP
#define DIO_u8_PC5_INITIAL_VALUE                DIO_u8_INITIAL_INPUT_PULLUP
#define DIO_u8_PC6_INITIAL_VALUE                DIO_u8_INITIAL_INPUT_PULLUP
#define DIO_u8_PC7_INITIAL_VALUE                DIO_u8_INITIAL_INPUT_PULLUP

#define DIO_u8_PD0_INITIAL_VALUE                DIO_u8_INITIAL_OUTPUT_LOW
#define DIO_u8_PD1_INITIAL_VALUE                DIO_u8_INITIAL_OUTPUT_LOW
